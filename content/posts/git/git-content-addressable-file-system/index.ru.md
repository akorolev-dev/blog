...
Каждый сорокасимвольный хеш вычисляется на основе содержимого соответствующего объекта.
...
Содержится хеш объекта **tree**, он как раз совпадает с адресом второго объекта, который появился после создания коммита.
...
- новый blob для main.txt
  А вот по части файла LICENSE, содержимое которого не поменялось, будет переиспользован ранее созданный объект, ведь его хеш-адрес остался тем же.
...
![Создание легкого и аннотированного тегов](object-type-tag.jpg#center "Создание легкого и аннотированного тегов")
